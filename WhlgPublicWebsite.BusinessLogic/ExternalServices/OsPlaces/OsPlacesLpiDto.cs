...
public class OsPlacesLpiDto : IComparable<OsPlacesLpiDto>
{
    ...
    public int CompareTo(OsPlacesLpiDto other)
    {
        var result = CompareStrings(TownName, other.TownName);
        if (result != 0) return result;

        result = CompareStrings(LocalityName, other.LocalityName);
        if (result != 0) return result;

        result = CompareStrings(AreaName, other.AreaName);
        if (result != 0) return result;

        result = CompareStrings(StreetDescription, other.StreetDescription);
        if (result != 0) return result;

        result = CompareNumberStrings(PaoStartNumber, other.PaoStartNumber);
        if (result != 0) return result;

        result = CompareStrings(PaoStartSuffix, other.PaoStartSuffix);
        if (result != 0) return result;

        result = CompareStrings(PaoText, other.PaoText);
        if (result != 0) return result;

        result = CompareNumberStrings(SaoStartNumber, other.SaoStartNumber);
        if (result != 0) return result;

        result = CompareStrings(SaoStartSuffix, other.SaoStartSuffix);
        if (result != 0) return result;

        return CompareStrings(SaoText, other.SaoText);
        ...
        int CompareNumberStrings(string a, string b)
        {
            var aNumber = !string.IsNullOrEmpty(a) ? int.Parse(a) : 0;
            var bNumber = !string.IsNullOrEmpty(b) ? int.Parse(b) : 0;
    ...
    [JsonProperty("USRN")] public string Usrn { get; set; }

    [JsonProperty("LPI_KEY")] public string LpiKey { get; set; }

    [JsonProperty("LEVEL")] public string Level { get; set; }

    [JsonProperty("ORGANISATION")] public string Organisation { get; set; }

    [JsonProperty("SAO_START_NUMBER")] public string SaoStartNumber { get; set; }

    [JsonProperty("SAO_START_SUFFIX")] public string SaoStartSuffix { get; set; }

    [JsonProperty("SAO_END_NUMBER")] public string SaoEndNumber { get; set; }

    [JsonProperty("SAO_END_SUFFIX")] public string SaoEndSuffix { get; set; }

    [JsonProperty("SAO_TEXT")] public string SaoText { get; set; }

    [JsonProperty("PAO_START_NUMBER")] public string PaoStartNumber { get; set; }

    [JsonProperty("PAO_START_SUFFIX")] public string PaoStartSuffix { get; set; }

    [JsonProperty("PAO_END_NUMBER")] public string PaoEndNumber { get; set; }

    [JsonProperty("PAO_END_SUFFIX")] public string PaoEndSuffix { get; set; }

    [JsonProperty("PAO_TEXT")] public string PaoText { get; set; }

    [JsonProperty("STREET_DESCRIPTION")] public string StreetDescription { get; set; }

    [JsonProperty("LOCALITY_NAME")] public string LocalityName { get; set; }

    [JsonProperty("TOWN_NAME")] public string TownName { get; set; }

    [JsonProperty("ADMINISTRATIVE_AREA")] public string AdministrativeArea { get; set; }

    [JsonProperty("AREA_NAME")] public string AreaName { get; set; }

    [JsonProperty("POSTCODE_LOCATOR")] public string PostcodeLocator { get; set; }

    [JsonProperty("RPC")] public string Rpc { get; set; }

    [JsonProperty("X_COORDINATE")] public double XCoordinate { get; set; }

    [JsonProperty("Y_COORDINATE")] public double YCoordinate { get; set; }
    ...
    [JsonProperty("MATCH_DESCRIPTION")] public string MatchDescription { get; set; }

    [JsonProperty("LOCAL_CUSTODIAN_CODE")] public string LocalCustodianCode { get; set; }

    [JsonProperty("LOCAL_CUSTODIAN_CODE_DESCRIPTION")]
    public string LocalCustodianCodeDescription { get; set; }

    [JsonProperty("CLASSIFICATION_CODE")] public string ClassificationCode { get; set; }

    [JsonProperty("CLASSIFICATION_CODE_DESCRIPTION")]
    public string ClassificationCodeDescription { get; set; }

    [JsonProperty("POSTAL_ADDRESS_CODE")] public string PostalAddressCode { get; set; }

    [JsonProperty("POSTAL_ADDRESS_CODE_DESCRIPTION")]
    public string PostalAddressCodeDescription { get; set; }

    [JsonProperty("STREET_STATE_CODE")] public string StreetStateCode { get; set; }
    ...
    [JsonProperty("LOGICAL_STATUS_CODE")] public string LogicalStatusCode { get; set; }

    [JsonProperty("BLPU_STATE_CODE")] public string BlpuStateCode { get; set; }
    ...
    [JsonProperty("PARENT_UPRN")] public string ParentUprn { get; set; }

    [JsonProperty("LAST_UPDATE_DATE")] public string LastUpdateDate { get; set; }

    [JsonProperty("ENTRY_DATE")] public string EntryDate { get; set; }

    [JsonProperty("LEGAL_NAME")] public string LegalName { get; set; }

    [JsonProperty("BLPU_STATE_DATE")] public string BlpuStateDate { get; set; }
