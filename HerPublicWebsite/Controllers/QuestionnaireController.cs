...
public class QuestionnaireController : Controller
{
    ...
    {
        var questionnaire = questionnaireService.GetQuestionnaire();
        await sessionRecorderService.SetEligibilityAndJourneyComplete(questionnaire, false);
    ...
    {
        var questionnaire = questionnaireService.GetQuestionnaire();
        await sessionRecorderService.SetEligibilityAndJourneyComplete(questionnaire, null);
