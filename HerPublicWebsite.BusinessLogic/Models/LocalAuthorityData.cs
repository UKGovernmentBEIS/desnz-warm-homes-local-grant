...
public class LocalAuthorityData
{
    ...
    public static readonly Dictionary<string, LocalAuthorityDetails> LocalAuthorityDetailsByCustodianCode = new()
    {
        ...
        { "3720", new LocalAuthorityDetails("Stratford-on-Avon District Council", Hug2Status.Pending, "https://www.stratford.gov.uk/", IncomeBandOptions[IncomeThreshold._31000], "Midlands Net Zero Hub") },
