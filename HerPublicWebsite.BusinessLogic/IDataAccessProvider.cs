...
public interface IDataAccessProvider
{
    ...
    Task<IList<ReferralRequest>> GetAllReferralRequestsToNonPending();
    Task<IList<ReferralRequest>> GetReferralRequestsToNonPendingBetweenDates(DateTime startDate, DateTime endDate);
