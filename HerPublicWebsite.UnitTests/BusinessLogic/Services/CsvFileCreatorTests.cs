...
"Name,Email,Telephone,Preferred contact method,Address1,Address2,Town,County,Postcode,Uprn,EPC Band,Is off gas grid,Household income band,Is eligible postcode,Tenure\r\n" +
"Full Name1,contact1@example.com,00001 123456,Email,Address 1 line 1,Address 1 line 2,Town1,County1,AL01 1RS,100 111 222 001,E,yes,Below £31k,no,Owner\r\n");
    }
    ...
    public void CreateFileData_CalledWithReferralRequestWithGasBoiler_GeneratesExpectedFileData()
    {
        ...
        reader.ReadToEnd().Should().Be(
"Name,Email,Telephone,Preferred contact method,Address1,Address2,Town,County,Postcode,Uprn,EPC Band,Is off gas grid,Household income band,Is eligible postcode,Tenure\r\n" +
"Full Name1,contact1@example.com,00001 123456,Email,Address 1 line 1,Address 1 line 2,Town1,County1,AL01 1RS,100 111 222 001,E,no,Below £31k,no,Owner\r\n");
    }
    ...
    public void CreateFileData_CalledWithReferralRequestWithUnknownGasBoiler_GeneratesExpectedFileData()
    {
        ...
        reader.ReadToEnd().Should().Be(
"Name,Email,Telephone,Preferred contact method,Address1,Address2,Town,County,Postcode,Uprn,EPC Band,Is off gas grid,Household income band,Is eligible postcode,Tenure\r\n" +
"Full Name1,contact1@example.com,00001 123456,Email,Address 1 line 1,Address 1 line 2,Town1,County1,AL01 1RS,100 111 222 001,E,unknown,Below £31k,no,Owner\r\n");
    }
    ...
    public void CreateFileData_CalledWithReferralRequestWithIncomeAbove31k_GeneratesExpectedFileData()
    {
        ...
        reader.ReadToEnd().Should().Be(
"Name,Email,Telephone,Preferred contact method,Address1,Address2,Town,County,Postcode,Uprn,EPC Band,Is off gas grid,Household income band,Is eligible postcode,Tenure\r\n" +
"Full Name1,contact1@example.com,00001 123456,Email,Address 1 line 1,Address 1 line 2,Town1,County1,AL01 1RS,100 111 222 001,E,yes,£31k or above,no,Owner\r\n");
    }
...
"Name,Email,Telephone,Preferred contact method,Address1,Address2,Town,County,Postcode,Uprn,EPC Band,Is off gas grid,Household income band,Is eligible postcode,Tenure\r\n" +
"Full Name1,contact1@example.com,00001 123456,Email,Address 1 line 1,Address 1 line 2,Town1,County1,AL01 1RS,100 111 222 001,E,yes,Below £31k,no,Owner\r\n" +
"Full Name2,contact2@example.com,00002 123456,Email,Address 2 line 1,Address 2 line 2,Town2,County2,AL02 1RS,100 111 222 002,E,yes,Below £31k,no,Owner\r\n" +
"Full Name3,contact3@example.com,00003 123456,Email,Address 3 line 1,Address 3 line 2,Town3,County3,AL03 1RS,100 111 222 003,E,yes,Below £31k,no,Owner\r\n");
    }
}
