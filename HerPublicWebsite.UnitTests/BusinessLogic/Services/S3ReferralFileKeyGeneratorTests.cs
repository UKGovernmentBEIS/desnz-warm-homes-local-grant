...
public class S3ReferralFileKeyGeneratorTests
{
    ...
    public void GetS3Key_WhenCalledWithValidData_CreatesCorrectKey(int custodianCode, int month, int year, string expectedKey)
    {
        // Act
    ...
    [TestCase(-1, 1, 2020)] // Invalid custodian code
    ...
    public void GetS3Key_WhenCalledWithInvalidData_ThrowsException(int custodianCode, int month, int year)
    {
        // Act and Assert
